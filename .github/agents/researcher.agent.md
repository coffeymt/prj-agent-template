...
- **Internal**: Read relevant source files, configs, documentation, and skill files. Use search to locate patterns across the codebase.
- **External**: Use #context7 for library/framework docs. Use #fetch for API references, platform documentation, or release notes.
